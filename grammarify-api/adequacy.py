class Adequacy:
    ...
    def __init__(self, model_tag='sanjay-m1/parrot-adequacy-on-BART'):
        from transformers import AutoModelForSequenceClassification, AutoTokenizer
        self.nli_model = AutoModelForSequenceClassification.from_pretrained(model_tag, cache_dir="models/")
        self.tokenizer = AutoTokenizer.from_pretrained(model_tag, cache_dir="models/")
        print("[Adequacy] - Parrot Adequacy model loaded")
